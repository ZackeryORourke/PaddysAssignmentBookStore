...
public class RegisterActivity extends AppCompatActivity {
    ...
    private Button btnSignIn, btnSignUp, btnResetPassword, btnSignUpDeveloper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUpDeveloper = (Button) findViewById(R.id.sign_up_buttonDeveloper);
        ...
        btnSignUpDeveloper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
